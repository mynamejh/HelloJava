...
public class MemberSearch implements Command {
	...
	public void exec(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// id를입력. memberResult/ memberSearchOutput.jsp
		...
		//요청정보(req)의 속성에 vo의 값을 담아서 넘기기
		req.setAttribute("memberInfo", vo);// member vo 가 주소값을 넘겨줌
		
		//forward 요청정보, 응답정보를,"jsp " 를 호출하면서 매개값 넘어옴 
